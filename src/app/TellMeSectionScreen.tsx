...
import { isTellMeCategory } from '../features/review/languagePolicy';
 ...
 * lessons that grow one sentence say so in that single row.
 */
export default function TellMeSectionScreen() {
  ...
  if (!category || !isTellMeCategory(category)) {
    return (
      <div className="screen">
        <ScreenHeader title="Section not found" back />
        <div className="empty">
          <LevantMotif name="amphora" />
          <p>This Tell Me About It section is not on this device.</p>
