...
import { lessonLines, lessonsOf } from '../features/tellme/tellme';
 ...
 * The study ladder will deal these same cards in this same order, but a
 * learner should first *see* how the sentence grows — on this level the added
 * piece is usually a connector and whatever it pulled in, which is the very
 * thing being taught — before anything is scored. The practise buttons at the
 * foot hand over to the ordinary study screen, one language rung at a time.
 */
export default function TellMeLessonScreen() {
  ...
  if (!entry || !category || !lesson || !isTellMeCategory(category)) {
    return (
  ...
  return (
    <div className="screen">
      ...
      <p className="small muted">
        {asked
          ? 'Each line answers the question above it. Read the question first — an answer of several sentences is still an answer to one question.'
          : 'Read the lines before practising them. Where a line grows the one before it, the added words are marked — on this level they are usually a joining word and whatever it brought with it.'}
      </p>
